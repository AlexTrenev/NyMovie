...
export default function About() {
  return (
        <div className="max-w-4xl w-full mx-auto pt-32 md:pt-48 pb-24">
            ...
            <p>Powered by The Movie Database & Open Movie Database.</p>

            <p>Personal movie collections coming soon.<p>
           </p>For feedback or inquiries, mail me at rhubarborc@proton.me ₍^. .^₎Ⳋ</p>
